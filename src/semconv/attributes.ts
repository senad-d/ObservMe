...
export const RESOURCE_ATTRIBUTES = {
  ...
  PI_AGENT_DISPLAY_NAME: "pi.agent.display_name",
...
export const AGENT_SPAWN_ATTRIBUTES = {
  ...
  PI_AGENT_CHILD_DISPLAY_NAME: "pi.agent.child.display_name",
  PI_AGENT_CHILD_ROLE: "pi.agent.child.role",
  PI_AGENT_CHILD_CAPABILITY: "pi.agent.child.capability",
